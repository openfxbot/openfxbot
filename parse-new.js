...
var rankBase = {};
var rankOther = {};
var baseTotal = {usd:0, gbp:0, aud:0, eur:0, nzd:0, chf:0, cad:0, jpy:0};
var otherTotal = {usd:0, gbp:0, aud:0, eur:0, nzd:0, chf:0, cad:0, jpy:0};
...
parser.on('finish', function(){
	...
	_.each(union, function(key) {
		var avgBase = key !== 'jpy' ? (rankBase[key] || 0.0) / baseTotal[key] : 0.0;
		var avgOther = key !== 'eur' ? (rankOther[key] || 0.0) / otherTotal[key] : 0.0;
		console.log( 100.0 * (avgBase + avgOther), key);
	});
});
